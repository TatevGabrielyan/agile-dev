<?php
    ...
    if($action == 'read'){
        $sql = $conn->query("SELECT * FROM vals");
        $vals = array();
    ...
    if($action == 'create'){
        ...
        $sql = $conn->query("INSERT INTO vals (value) VALUES ('$value')");
        if($sql){
    ...
    if($action == 'update'){
        ...
        $sql = $conn->query("UPDATE vals SET value='$value' WHERE id='$id'" );
    ...
    if($action == 'delete'){
        ...
        $sql = $conn->query("DELETE FROM vals WHERE id='$id'");
